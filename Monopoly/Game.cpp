...
vector<unique_ptr<Tile>> create_field(void)
{
	...
	field.push_back(unique_ptr<Tile>(new Action_tile(Tile::Tile_Type::Start, new EmptyAction())));
	field.push_back(unique_ptr<Tile>(new Street(Street::StreetColors::brown, "mediter-ranean avenue", {}, 60)));
	field.push_back(unique_ptr<Tile>(new Action_tile(Tile::Tile_Type::CommChest,new TakeCommChest())));
	field.push_back(unique_ptr<Tile>(new Street(Street::StreetColors::brown, "baltic avenue", {}, 60)));
	field.push_back(unique_ptr<Tile>(new Action_tile(Tile::Tile_Type::Tax,new Pay2BankAction(200))));
	...
	field.push_back(unique_ptr<Tile>(new Action_tile(Tile::Tile_Type::Chance,new TakeChance())));
	...
	field.push_back(unique_ptr<Tile>(new Action_tile(Tile::Tile_Type::Jail,new EmptyAction())));
	field.push_back(unique_ptr<Tile>(new Street(Street::StreetColors::pink, "st.charles place", {}, 140)));
	field.push_back(unique_ptr<Tile>(new Action_tile(Tile::Tile_Type::Service,new EmptyAction())));
	...
	field.push_back(unique_ptr<Tile>(new RailRoad({}, "Kursk railway station")));
	...
	field.push_back(unique_ptr<Tile>(new Action_tile(Tile::Tile_Type::FreeParking,new EmptyAction())));
	...
	field.push_back(unique_ptr<Tile>(new RailRoad({},"Ryazan railroad station")));
	...
	field.push_back(unique_ptr<Tile>(new Action_tile(Tile::Tile_Type::GoToJail,new EmptyAction())));
	...
	field.push_back(unique_ptr<Tile>(new RailRoad({}, "Leningrad railroad station")));
	field.push_back(unique_ptr<Tile>(new Action_tile(Tile::Tile_Type::Chance,new TakeChance())));
	field.push_back(unique_ptr<Tile>(new Street(Street::StreetColors::dark_blue, "park place", {}, 350)));
	field.push_back(unique_ptr<Tile>(new Action_tile(Tile::Tile_Type::Tax,new Pay2BankAction(100))));
